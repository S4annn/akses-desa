    ...
    <footer className="relative mt-16 bg-slate-900 text-slate-300">
      ...
      <div className="container-page relative grid gap-10 py-12 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-3 text-sm">
            <li className="flex gap-2"><MapPin className="mt-0.5 h-4 w-4 text-brand-400" /><span>{village.address}</span></li>
            <li className="flex gap-2"><Phone className="mt-0.5 h-4 w-4 text-brand-400" /><span>{village.phone}</span></li>
            <li className="flex gap-2"><Mail className="mt-0.5 h-4 w-4 text-brand-400" /><span>{village.email}</span></li>
          </ul>
      ...
      <div className="border-t border-white/10">
        <div className="container-page flex flex-col items-center justify-between gap-2 py-4 text-xs text-slate-500 sm:flex-row">
          <p>© {new Date().getFullYear()} AksesDesa. Semua hak dilindungi.</p>
